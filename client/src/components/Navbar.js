...
import { useFirebase } from "../context/Firebase";
import { Avatar } from "@mui/material";
import Logo from '../assets/lgoo.jfif'
import avatar from "../assets/avatar.jpg";
import CoursesLogo from "../assets/logo.jfif";
...
const Navbar = () => {
  ...
  return (
    <div
      style={{ height: "12vh", backgroundColor: "black", paddingTop: "25px",paddingBottom:"25px" }}
    >
      <ul
        style={{
          display: "flex",
      ...
      >
        <li>
          ...
          >
            <img src={Logo} style={{width:"250px", height:"50px",backgroundColor:'black'}}></img>
          </Link>
        </li>
        {firebase.isLoggedIn && <>
            <li>
